...
<div style="width:758px;height:30px;background-color:#FFFF80;margin:10px auto;padding-top:5px;">
<center><span style="color:#666666;font-size:16px;font-family:Arial, Helvetica, sans-serif;">HOJA DE TRABAJO</span></center>
</div>  
...
<center>
<table width="1117" height="199" cellpadding="2" cellspacing="0" style="border:1px #DD6F00 solid;">
  <tr>
    ...
    <td colspan="2" style="background-color:#DD6F00;color:#FFFFFF;border-bottom:1px #E1E1E1 solid;border-right:1px #E1E1E1 solid;">SALDOS AJUSTADOS </td>
  ...
  <tr>
    ...
    <td width="85" style="background-color:#DD6F00;color:#FFFFFF;border-right:1px #E1E1E1 solid;"><span class="style1"><center>INGRESOS</center></span></td>
    <td width="86" style="background-color:#DD6F00;color:#FFFFFF;border-right:1px #E1E1E1 solid;"><center>
      DEBE
    </center></td>
    <td width="77" style="background-color:#DD6F00;color:#FFFFFF;border-right:1px #E1E1E1 solid;">HABER</td>
    <td width="77" style="background-color:#DD6F00;color:#FFFFFF;border-right:1px #E1E1E1 solid;">DEBE</td>
    <td width="73" style="background-color:#DD6F00;color:#FFFFFF;border-right:1px #E1E1E1 solid;">HABER</td>
    <td width="84" style="background-color:#DD6F00;color:#FFFFFF;border-right:1px #E1E1E1 solid;">ACTIVOS</td>
    <td width="92" style="background-color:#DD6F00;color:#FFFFFF;">
	<center>
	  PASIVO Y PATRIMONIO
	</center></td>
  </tr>
	...
	?>
	  ...
	  <?php echo $result['codigo_cuenta_contable']?></td>
  	  ...
  	  <td style="border-bottom:1px #DD6F00 solid;border-right:1px #DD6F00 solid;">
	  <?php echo $result['nombre']?></td>
		...
		?>
  	   ...
  	   <td style="border-bottom:1px #DD6F00 solid;border-right:1px #E1E1E1 solid;">
	    <?php
	   ...
	   <td style="border-bottom:1px #DD6F00 solid;border-right:1px #DD6F00 solid;">
		...
		?>	   </td>
	   <td style="border-bottom:1px #DD6F00 solid;border-right:1px #E1E1E1 solid;">&nbsp;</td>
	   <td style="border-bottom:1px #DD6F00 solid;border-right:1px #DD6F00 solid;">&nbsp;</td>
	   <td style="border-bottom:1px #DD6F00 solid;">&nbsp;</td>
	   <td style="border-bottom:1px #DD6F00 solid;border-right:1px #DD6F00 solid;">&nbsp;</td>
  ...
  ?>
  	...
  	<tr>
  	  ...
  	  <td height="27" style="border-top:none;border-right:1px #E1E1E1 solid;">&nbsp;</td>
