...
<fieldset>
<legend><strong>Informacion Administrador</strong></legend>
...
<table width="788"  border="0" id="example">
  <thead>
    <tr >
	  <td width="223" height="25"><span class="Estilo15">Codigo Persona</span></td>
	  <td width="310" height="25"><span class="Estilo15">Nombres y Apellidos</span></td>
	  <td width="136" height="25"><span class="Estilo15">Edad</span></td>
...
include('Conexion.php');
	$sql=$cn->prepare('SELECT codigo_persona,(nombre_paterno_materno(codigo_persona))datos,(edad(codigo_persona))edad FROM administrador');	
	$sql->execute();		
...
<tr>
  ...
  <td><span class="Estilo3"><?php echo $op['datos'];?></span></td>
   ...
   <td><span class="Estilo3"><?php echo $op['edad'];?> años</span></td>
