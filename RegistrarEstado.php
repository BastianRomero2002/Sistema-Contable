...
$consulta=$cn->prepare('SELECT * FROM cuenta WHERE codigo_cuenta NOT IN (SELECT codigo_cuenta FROM estado)');
$consulta->execute();
?>
...
<table width="776" height="48" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
   ...
   <td width="179" height="26" scope="row"><label for="label2">Codigo Cuenta:</label></td>
   <td width="90">
   
    <select size="1" name="Genero" id="CodigoCuenta">
	...
	?>
             ...
             <option value="<?php echo $result['codigo_cuenta']?>"><?php echo $result['codigo_cuenta'];?></option>
   ...
   <td width="40">&nbsp;</td>
   <td width="190"><label for="label3">Tipo:</label></td>
...
<table width="788"  border="0" id="example">
  <thead>
    <tr >
      ...
      <td width="106"><span class="Estilo15">Codigo Cuenta</span></td>
...
<tr>
  <td><span class="Estilo3"><?php echo $op['codigo_estado'];?></span></td>
