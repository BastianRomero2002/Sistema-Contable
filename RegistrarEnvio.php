...
function realizaProceso(){
        ...
        $.ajax({
                ...
                url:   'CrearEnvio.php',
                type:  'post',
                success:  function() {   alert('Tarjeta Registrado con Exito');  }
        });
}
</script>
...
<fieldset>
<legend><strong>Informacion Envio de Producto</strong></legend>
<table width="776" height="74" border="0" cellpadding="2" cellspacing="0">
 ...
 <tr>
	 ...
	 <option value="Envio Tangible">Envio Tangible</option>
	 <option value="Envio Intangible">Envio Intangible</option>
  ...
  <tr>
     <td width="16" scope="row">&nbsp;</td>
     <td width="180" height="26" scope="row"><label for="label">Costo:</label></td>
     <td width="246"><input type="text" name="T2"  size="30" maxlength="40" id="Costo" /></td>
     <td width="29">&nbsp;</td>
 </tr>
</table>
 </fieldset>
...
<table width="788"  border="0" id="example">
  <thead>
    <tr >
	  <td width="128" height="25"><span class="Estilo15">Codigo Envio</span></td>
  ...
  <tbody>
	...
	$sql=$cn->prepare('SELECT * FROM envio');	
	$sql->execute();		
...
<tr>
  <td><span class="Estilo3"><?php echo $op['codigo_envio'];?></span></td>
