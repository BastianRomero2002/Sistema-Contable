...
$consulta=$cn->prepare('SELECT * FROM empleado WHERE codigo_persona NOT IN (SELECT codigo_persona FROM e_trabaja)');
$consulta->execute();
...
<fieldset>
<legend><strong>Informacion Empleado Supervisa</strong></legend>
...
<table width="789"  border="0" id="example">
 ...
 <td width="128" height="25"><span class="Estilo15">Codigo Persona</span></td>
  ...
  <tbody>
	...
	$sql=$cn->prepare('SELECT * FROM e_supervisa');	
	$sql->execute();		
