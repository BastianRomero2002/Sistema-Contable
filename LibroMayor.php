...
$consulta=$cn->prepare('SELECT * FROM cuenta_contable ORDER BY codigo_cuenta_contable');
$consulta->execute();
?>

<div style="width:706px;height:80px;background-color:#FFFF80;margin:10px auto;padding-top:5px;">
<center>
<span style="color:#666666;font-size:16px;font-family:Arial, Helvetica, sans-serif;">EL GATO BLANCO</span><br />
<span style="color:#666666;font-size:16px;font-family:Arial, Helvetica, sans-serif;">LIBRO MAYOR</span><br />
<span style="color:#666666;font-size:16px;font-family:Arial, Helvetica, sans-serif;">AL 31 DE DICIEMBRE DE 2014</span><br />
<span style="color:#666666;font-size:16px;font-family:Arial, Helvetica, sans-serif;">EXPRESADO EN BOLIVIANOS</span>
