...
$consulta=$cn->prepare('SELECT * FROM cuenta_contable where nombre like "%Cuentas por Pagar%"  ORDER BY codigo_cuenta_contable');
$consulta->execute();
?>

<div style="width:706px;height:30px;background-color:#FFFF80;margin:10px auto;padding-top:5px;">
<center><span style="color:#666666;font-size:16px;font-family:Arial, Helvetica, sans-serif;">CUENTAS POR PAGAR</span></center>
</div>  	
